...
class HindiSummarizer:
    def __init__(self, model_path='hindi_model.pkl'):
        ...
        self.important_words = set([
            'बताया','कहा','हुआ','हुई','हुए','दिया','दिए','लिया','लिए','गया','गई','गए',
            'प्रधानमंत्री','मंत्री','राष्ट्रपति','मुख्यमंत्री','केंद्र','राज्य','सरकार',
            'भारत','देश','विश्व','अंतरराष्ट्रीय','राष्ट्रीय','नेता','अधिकारी','पुलिस',
            'आज','कल','आजतक','अबतक','हाल ही','नया','नई','नए','पुराना','महत्वपूर्ण',
            'बड़ा','बड़ी','बड़े','छोटा','पहला','पहली','आखिरी','अंतिम','प्रमुख','वरिष्ठ',
            'युवा','विकास','योजना','नीति','कार्यक्रम','अभियान','मुहिम','कानून','विधेयक',
            'चुनाव','मतदान','वोट','पार्टी','दल','गठबंधन','सदन','संसद','विधानसभा',
            'अर्थव्यवस्था','बजट','वित्त','कर','टैक्स','महंगाई','बेरोजगारी','रोजगार'
        ])
        try:
    ...
    def calculate_keyword_score(self, sentence):
        ...
        for word in words:
            if word and word[0].isupper():
                ...
                important_count += 1.5
            elif word not in self.hindi_stopwords and len(word) > 3:
                important_count += 1
